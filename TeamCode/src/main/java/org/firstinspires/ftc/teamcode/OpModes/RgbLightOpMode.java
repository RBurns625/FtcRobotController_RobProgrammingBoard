...
public class RgbLightOpMode extends OpMode {
    ...
    public void loop() {
        ...
        if(gamepad1.a) board.setServoPosition(0.277);
        if (gamepad1.b) board.setServoPosition(0.388);
        if (gamepad1.x) board.setServoPosition(0.500);
        if (gamepad1.y) board.setServoPosition(0.611);
        if (gamepad1.left_stick_button) board.setServoPosition(0.0);
        if (gamepad1.dpad_up) board.setServoPosition(0.333);
        if (gamepad1.dpad_left) board.setServoPosition(0.444);
        if (gamepad1.dpad_right) board.setServoPosition(0.555);
        if (gamepad1.dpad_down) board.setServoPosition(0.666);
